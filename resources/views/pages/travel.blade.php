...
@section('content')
    ...
    <article>
        <section id="content"
            class="__container !mx-auto md:!max-w-[588px] lg:!max-w-[1240px] grid grid-cols-9 text-justify !py-12">
            ...
            <div class="col-span-full lg:col-span-3 pt-[60px] text-center">
                <div class="shadow rounded-md bg-white p-5 border-blue-600 border-t-4">
                    <h2 class="!text-center !block !mb-6">Pesan Travel Online</h2>
                    <x-button :text=phone() class="!inline !no-underline !text-slate-100 hover:!text-blue-600" :transparant="false" />
                    <p class="mt-6">Hubungi {{ $page }} untuk pemesanan via online</p>
                </div>
            </div>
        </section>
    </article>
