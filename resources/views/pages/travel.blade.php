...
@section('content')
    ...
    <article>
        <section id="content" class="__container !max-w-[800px] text-justify !py-12">
            ...
            <p>
                Biaya dari {{ Str::title($travel[0]->name) }} menuju {{ Str::title($travel[1]->name) }} bisa berubah-rubah
            ...
            <p>Jadwal tersebut bisa berubah-rubah. Jika anda ingin berangkat sesuai jadwal yang diinginkan dan tidak tertera
            ...
            <p>Keselamatan dan kenyamanan dalam perjalanan menjadi prioritas kami. Kami akan berusaha sebaik mungkin untuk
                meningkatkanya. Setiap mobil yang kamu berangkat selalu dicuci dan diservice untuk menjamin keselamatan.
                Semua unit telah dilengkapi dengan fasilitas terbaik, seperti AC dan audio. Perjalanan anda semakin nyaman
                bersama {{ Str::upper(env('APP_NAME')) }}.</p>
            <h3>Rute Lengkap</h3>
