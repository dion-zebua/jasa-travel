    ...
    <div class="bg-gradient-to-bl from-blue-500 to-blue-700">
        <div class="bg-right-bottom " style="background-image: url({{ asset('img/blob.svg') }})">
            <div class="__container py-24">
                ...
                <div class="bg-slate-50 p-5 md:p-7 xl:p-10 mt-10">
                    <div
                        ...
                        @for ($i = 0; $i < 1; $i++)
                            <div class="">
                                <img src="{{ route('thumbnail', ['text' => 'Travel Kalimantan Barat Kalimantan Selatan']) }}"
                                    class="border border-b-0" alt="Travel">
                                <a href="#!"
                                    class="bg-blue-950 hover:bg-blue-900 text-slate-300 px-5 py-2 text-sm line-clamp-2 !leading-5 text-center font-bold">Pesan
                                    Travel</a>
                            </div>
                        @endfor
                    </div>
