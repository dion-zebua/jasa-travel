<div class="py-24 __container">
    <div class="">
        <div class="mx-auto max-w-2xl lg:text-center">
            <h2 class="text-base font-semibold leading-7 text-blue-600">Keuntungan Memilih Kami</h2>
            <p class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Solusi Transportasi Antar kota
                Untuk Anda</p>
