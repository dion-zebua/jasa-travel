<div class="__container">
    ...
    <div
        ...
        <img width="100" height="100" src="{{ asset('img/gallery/image2.png') }}" class="sm:!col-span-4" alt="galeri 2">
        <img width="100" height="100" src="{{ asset('img/gallery/image3.png') }}" class="sm:!col-span-4" alt="galeri 3">
        <img width="100" height="100" src="{{ asset('img/gallery/image4.png') }}" class="sm:!col-span-8" alt="galeri 4">
        <img width="100" height="100" src="{{ asset('img/gallery/image5.png') }}" class="sm:!col-span-6" alt="galeri 5">
        <img width="100" height="100" src="{{ asset('img/gallery/image6.png') }}" class="sm:!col-span-6" alt="galeri 6">
    </div>
</div>
